...
function TasksPanel({ onClose }: { onClose: () => void }) {
  ...
  return (
    <>
      ...
      <div className="fixed top-0 right-0 bottom-0 z-50 w-[380px] bg-white flex flex-col">
  ...
  return (
    <>
      ...
      <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
        <div className="bg-white rounded-2xl w-[520px] flex flex-col overflow-hidden">
          {/* Header */}
...
function InsightsChatPanel({ onClose }: { onClose: () => void }) {
  ...
  return (
    <>
      <div className="fixed inset-0 z-40 bg-black/20" onClick={onClose} />
      <div className="fixed top-0 right-0 bottom-0 z-50 w-[400px] bg-white flex flex-col">
        {/* Header */}
        <div className="flex items-center justify-between px-5 py-4 border-b border-[#f0f0f0]">
  ...
  return (
    <>
      ...
      <div className="fixed inset-0 z-50 flex items-center justify-center p-6">
        <div className="bg-white rounded-2xl w-full max-w-2xl flex flex-col" style={{ maxHeight: "90vh" }}>
          {/* Header */}
  ...
  return (
    <>
      ...
      <div className="fixed inset-0 z-[60] flex items-center justify-center p-4">
        <div className="bg-white rounded-2xl w-[520px] flex flex-col" style={{ maxHeight: "85vh" }}>
          {/* Header */}
          <div className="flex items-center justify-between px-6 py-4 border-b border-[#f0f0f0] shrink-0">
            <div>
...
function AgentLogModal({ onClose }: { onClose: () => void }) {
  ...
  return (
    <>
      <div className="fixed inset-0 z-40 bg-black/30" onClick={onClose} />
      <div className="fixed inset-0 z-50 flex items-center justify-center p-6">
        <div className="bg-white rounded-2xl w-full max-w-lg flex flex-col" style={{ maxHeight: "80vh" }}>
          <div className="flex items-center justify-between px-6 py-4 border-b border-[#f0f0f0] shrink-0">
            <div>
    ...
    <div className="flex flex-col gap-4 h-full">
      ...
      <div className="bg-[#f7f7f7] rounded-2xl px-4 py-5 flex flex-col gap-6 shrink-0">
        ...
        <div className="flex items-center gap-2 w-full">
          ...
          <button
            onClick={() => router.push("/roles/new/alignment")}
            className="flex items-center gap-2 px-4 py-3 rounded-[14px] text-white text-[14px] font-normal leading-5 tracking-[-0.15px] whitespace-nowrap transition-all duration-150 active:scale-[0.95] hover:opacity-90"
            style={{ background: "linear-gradient(171.3deg, #0e3d27 16.33%, #1f6b43 71.81%)" }}
          >
          ...
          <button
            ...
            className="flex items-center justify-center h-10 px-[17px] py-[13px] rounded-[14px] border border-[#0e3d27] text-[14px] font-medium text-[#4b5563] leading-5 whitespace-nowrap hover:bg-[#f0faf4] transition-all duration-150 active:scale-[0.95]"
          >
            Import data
          </button>
        </div>
        ...
        <div className="flex items-center justify-between w-full">
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="relative" ref={calendarRef}>
                <button
                  ...
                  className={`w-10 h-10 rounded-[10px] border flex items-center justify-center transition-all duration-150 active:scale-[0.9] ${
                    showCalendar
          ...
          <div className="flex items-center gap-[60px] pr-[60px]">
            ...
            <button
              ...
              className="w-[60px] h-[60px] rounded-full border border-[#0e3d27] bg-[#f7f7f7] flex items-center justify-center hover:bg-[#e8f5ee] transition-all duration-150 active:scale-[0.9]"
            >
          ...
          <div className="bg-white rounded-[14px] p-4 flex flex-col gap-4 flex-1 min-w-0">
            <div className="flex items-center justify-between h-[53.5px]">
              ...
              <button
                ...
                className="bg-[#1f6b43] text-white text-[12px] font-normal leading-[19.5px] tracking-[-0.076px] px-4 py-3 rounded-[10px] whitespace-nowrap hover:bg-[#0e3d27] transition-all duration-150 active:scale-[0.95]"
              >
      ...
      {showInsights && <InsightsChatPanel onClose={() => setShowInsights(false)} />}
      {showLog && <AgentLogModal onClose={() => setShowLog(false)} />}
      {editingApproval && (
        <ApprovalEditModal
